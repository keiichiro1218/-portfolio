    ...
    <div class="p-profile">
        <div class="l-content__inner">
            ...
            <div class="">
                ...
                <p>
                    はじめまして千葉桂一郎です。
                    <br>サイトのコーディングやWordPressの案件を受注いたします。
                    <br>・デザインカンプのコーディングを外注したい方。
                    <br>・ホームページのメンテナンスや細かい修正をだれかに任せたい方。
                    <br>・WebサイトをWordPressを使用しかんたんに更新したい方。
                    <br>どんなに些細なことでもぜひお問い合わせください！
                </p>
            </div>
        </div>
    </div>
